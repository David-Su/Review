package com.wx.base.util.tools.string;
...
public final class StringTool {
    ...
    public String list2String(List<String> stringList) {
        ...
        return buffer.toString(); //最后一个“,”去掉
    }

    public List<String> string2List(String content, String splitFlag) {
        String[] split = content.split(splitFlag);
        return Arrays.asList(split);
    }

    public List<String> appendString(List<String> strings, String insertString) {
        List<String> stringList = new ArrayList<>();
        for (String s : strings) {
            stringList.add(insertString + s);
        }
     ...
     * @return
     */
    public String getWholeNumber(String src) {
        String number = "";
