package com.wx.base.util.tools;

import android.app.Application;
import android.content.Context;

import com.wx.base.util.tools.anim.AnimTool;
import com.wx.base.util.tools.apk.ApkTool;
import com.wx.base.util.tools.app.AppTool;
import com.wx.base.util.tools.app.InputMethodTool;
import com.wx.base.util.tools.app.IntentTool;
import com.wx.base.util.tools.app.ProcessTool;
import com.wx.base.util.tools.app.SnackbarTool;
import com.wx.base.util.tools.app.ToastTool;
import com.wx.base.util.tools.constants.ConstantsTool;
import com.wx.base.util.tools.convert.ConvertTool;
import com.wx.base.util.tools.device.DeviceTool;
import com.wx.base.util.tools.device.NetworkTool;
import com.wx.base.util.tools.image.BitmapTool;
import com.wx.base.util.tools.io.CloseTool;
import com.wx.base.util.tools.io.ExternalStorageTool;
import com.wx.base.util.tools.io.FileTool;
import com.wx.base.util.tools.io.SPTool;
import com.wx.base.util.tools.log.LogTool;
import com.wx.base.util.tools.math.MathTool;
import com.wx.base.util.tools.photo.CameraTool;
import com.wx.base.util.tools.regex.RegexTool;
import com.wx.base.util.tools.secure.SecureAESTool;
import com.wx.base.util.tools.secure.SecureBase64Tool;
import com.wx.base.util.tools.secure.SecureDES3Tool;
import com.wx.base.util.tools.secure.SecureDESTool;
import com.wx.base.util.tools.secure.SecureHexTool;
import com.wx.base.util.tools.secure.SecureMD5Tool;
import com.wx.base.util.tools.secure.SecureRSATool;
import com.wx.base.util.tools.secure.SecureTool;
import com.wx.base.util.tools.shell.ShellTool;
import com.wx.base.util.tools.string.StringTool;
import com.wx.base.util.tools.time.TimeTool;
...
public class Tools {
    ...
    private static AnimTool mAnim;
    private static CameraTool mCamera;
    private static MathTool mMathTool;
    ...
    public static AnimTool anim() {
        if (mAnim == null) {
            mAnim = AnimTool.instance();
        }
        return mAnim;
    }

    public static CameraTool camera() {
        if (mCamera == null) {
            mCamera = CameraTool.instance();
        }
        return mCamera;
    }
