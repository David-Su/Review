package com.wx.base.util.tools.apk;
...
public final class ApkTool {
    ...
    public void installApp(Context context, File file) {
        ...
        context.startActivity(Tools.intent().getInstallAppIntent(file,null));
    }
     ...
     * @param file    文件
     */
    public void installApp(Context context, File file,String authority) {
        if (!Tools.file().isFileExists(file)) return;
        context.startActivity(Tools.intent().getInstallAppIntent(file,authority));
    }
    ...
    public void installApp(Activity activity, File file, int requestCode) {
        if (!Tools.file().isFileExists(file)) return;
        activity.startActivityForResult(Tools.intent().getInstallAppIntent(file,null), requestCode);
    }
     ...
     * @param requestCode 请求值
     */
    public void installApp(Activity activity, File file, int requestCode,String authority) {
        if (!Tools.file().isFileExists(file)) return;
        activity.startActivityForResult(Tools.intent().getInstallAppIntent(file,authority), requestCode);
    }
